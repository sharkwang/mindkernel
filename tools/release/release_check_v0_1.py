...
def main():
    ...
    checks = [
        ...
        CheckItem("validate-scheduler-lease-renew", ["python3", "tools/validation/validate_scheduler_lease_renew_v0_1.py"]),
        CheckItem("validate-temporal-governance-worker", ["python3", "tools/validation/validate_temporal_governance_worker_v0_1.py"]),
        CheckItem("validate-temporal-verify-revalidate", ["python3", "tools/validation/validate_temporal_verify_revalidate_v0_1.py"]),
        ...
        CheckItem("validate-scheduler-benchmark", ["python3", "tools/validation/validate_scheduler_benchmark_v0_1.py"]),
        CheckItem("validate-vector-readiness", ["python3", "tools/validation/validate_vector_readiness_v0_1.py"]),
